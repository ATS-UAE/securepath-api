...
exports.TrackerManagement = void 0;
const moment_1 = __importDefault(require("moment"));
const _1 = require(".");
const helpers_1 = require("../helpers");
class TrackerManagement extends _1.Api {
    constructor() {
        super(...arguments);
        this.getTrackers = () => __awaiter(this, void 0, void 0, function* () {
            yield this.checkLogin();
            const trackers = yield this.api.get(`${this.options.baseUrl}/php/getpage.php?mode=admin&fx=getAllTrackersList`);
            return trackers.data.map(({ chassisNo, imei, licensePlate, name, searchKeywords, simno, trackerid, trackerExpiry, type, users }) => ({
                ...
                trackerExpiry,
                deviceType: type,
                users: (users === null || users === void 0 ? void 0 : users.split(",")) || []
            }));
        });
        this.createTracker = (data) => __awaiter(this, void 0, void 0, function* () {
            yield this.checkLogin();
            const trackerId = yield this.api.get(`${this.options.baseUrl}/php/getpage.php?mode=admin&fx=getTrackerID`);
            ...
            yield this.api.post(`${this.options.baseUrl}/php/getpage.php?mode=admin&fx=insertTrackerCard`, helpers_1.stringifyQuery(params), {
                headers: {
        ...
        this.updateTracker = (trackerId, data) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.api.post(`${this.options.baseUrl}/php/getpage.php?mode=admin&fx=updateTrackerCard`, helpers_1.stringifyQuery(params), {
                headers: {
                    "Content-Type": "application/x-www-form-urlencoded"
                }
            });
        ...
        this.checkExistingImei = (imei) => __awaiter(this, void 0, void 0, function* () {
            const existing = yield this.api.get(`${this.options.baseUrl}/php/getpage.php?mode=admin&fx=validateIMEI&imei=${imei}`);
            if (existing.data.code === "exists") {
                throw new _1.DeviceExistingException();
            }
        });
